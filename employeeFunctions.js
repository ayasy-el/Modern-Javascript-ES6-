...
function filterEmployeesByAge(employees) {
  // Implementasikan fungsi filter di sini
}
...
function applyBonus(employees) {
  // Implementasikan fungsi map di sini
}
...
function calculateTotalSalary(employees) {
  // Implementasikan fungsi reduce di sini
}
...
function addNewEmployee(employees, newEmployee) {
  // Implementasikan spread operator di sini
}
...
function getFirstEmployeeDetails(employees) {
  // Implementasikan destructuring di sini
...
function employeeInfo(employee) {
  // Implementasikan template literals di sini
}
